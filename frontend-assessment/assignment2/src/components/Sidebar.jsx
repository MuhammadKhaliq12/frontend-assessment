...
const Sidebar = () => {
  ...
  return (
    <aside
      className="absolute bg-black text-white z-50 flex flex-col md:flex-row border-r md:border-r border-b md:border-b-0 border-gray-500 w-full md:w-auto h-full overflow-y-auto"
    ...
    >
      ...
      <div className="w-full md:w-14 flex md:flex-col items-center justify-between pt-4 pb-4 border-b md:border-b-0 md:border-r border-gray-500">
        <div className="flex md:flex-col items-center space-x-2 md:space-x-0 md:space-y-4">
          {/* Profile Images */}
          {[profileImg, profileImg2, profileImg3].map((src, index) => (
